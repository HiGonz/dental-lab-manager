<script lang="ts">
  import { createEventDispat<div class="bg-gradient-to-r from-blue-50 to-cyan-50 p-8 rounded-2xl border border-blue-100">
  ...
  export let gradientFrom: string = 'blue-50';
  export let gradientTo: string = 'cyan-50';
  export let borderColor: string = 'blue-100';
  export let iconColor: string = 'blue-600';
...
<div class="bg-gradient-to-r from-{gradientFrom} to-{gradientTo} p-8 rounded-2xl border border-{borderColor}">
  <div class="flex items-center mb-6">
    <div class="flex items-center justify-center w-10 h-10 bg-{iconColor} rounded-xl mr-4">
      <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
      </svg>
    </div>
